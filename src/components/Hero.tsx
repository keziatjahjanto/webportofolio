...
export default function Hero() {
  return (
    ...
    >
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-12 sm:flex-row sm:justify-between">
        ...
        <Image
          ...
          height={192}
          priority
          className="h-40 w-40 shrink-0 rounded-full border-4 border-white/80 object-cover shadow-md sm:h-48 sm:w-48"
        />
      </div>
    </section>
  );
